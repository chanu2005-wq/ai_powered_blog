...
import { assets, blog_data, comments_data } from "../assets/assets/assets.js";
  ...
  return data ? (
    <div className="relative">
      ...
      <div className="text-center mt-20 text-gray-600">
        ...
        <p className="inline-block py-1 px-4 rounded-full mb-6 border border-primary/5 text-sm font-medium text-primary">
          Michael Brown
        </p>
      </div>
